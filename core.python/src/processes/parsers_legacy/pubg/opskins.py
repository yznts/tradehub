...
class PubgOpskinsParserProcess(multiprocessing.Process):
    ...
    def run(self):
        while True:
            try:
                ...
                # Request new data
                resp = self.http.get('https://api.opskins.com/IPricing/GetAllLowestListPrices/v1?appid=578080')
                ...
                time.sleep(self.config.delays.parsers.pubg.opskins)
